 ...
 * @copyright 2007-2011
  ...
  **/
	...
	abstract class WideImage_Image
	{
		...
		{
			LibWideImage::assertValidImageHandle($handle);
			$this->handle = $handle;
		}
		...
		function isValid()
		{
			return LibWideImage::isValidImageHandle($this->handle);
		}
		 ...
		 * Example:
		 * <code>
		 * LibWideImage::load('image1.png')->resize(100, 100)->output('gif');
		 * </code>
		 * 
		 ...
		 * <code>
		 * $watermark = LibWideImage::load('logo.gif');
		 * $base = LibWideImage::load('picture.jpg');
		 ...
		 * <code>
		 * $image = LibWideImage::load('someimage.jpg'); // 100x150
		 ...
		 * LibWideImage::SIDE_TOP_LEFT, LibWideImage::SIDE_TOP,
		 * LibWideImage::SIDE_TOP_RIGHT, LibWideImage::SIDE_RIGHT,
		 * LibWideImage::SIDE_BOTTOM_RIGHT, LibWideImage::SIDE_BOTTOM, 
		 * LibWideImage::SIDE_BOTTOM_LEFT, LibWideImage::SIDE_LEFT, and LibWideImage::SIDE_ALL.
		 * You can specify any combination of corners with a + operation, see example below.
		 * 
		 * Example:
		 * <code>
		 * $white = $image->allocateColor(255, 255, 255);
		 * $diagonal_corners = $image->roundCorners(15, $white, 2, LibWideImage::SIDE_TOP_LEFT + LibWideImage::SIDE_BOTTOM_RIGHT);
		 * $right_corners = $image->roundCorners(15, $white, 2, LibWideImage::SIDE_RIGHT);
		 * </code>
		 * 
		 ...
		 * @param int $corners Specify which corners to draw (defaults to LibWideImage::SIDE_ALL = all corners)
		...
		function __wakeup()
		{
			$temp_image = LibWideImage::loadFromString($this->sdata);
