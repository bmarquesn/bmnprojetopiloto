...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container">
			...
			<p><em>Clique sobre o Estado do Prospect para alterar seu status</em><img src="<?php echo base_url().'assets/img/carregando.gif'; ?>" title="Carregando" class="carregando" /></p>
