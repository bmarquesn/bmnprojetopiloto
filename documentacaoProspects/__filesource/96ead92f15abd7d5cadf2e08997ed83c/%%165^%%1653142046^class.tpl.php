...
media/images/<?php if ($this->_tpl_vars['abstract']):  if ($this->_tpl_vars['access'] == 'private'): ?>AbstractPrivate<?php else: ?>Abstract<?php endif;  else:  if ($this->_tpl_vars['access'] == 'private'): ?>Private<?php endif;  endif; ?>Class_logo.png"
...
media/images/StaticMethod.png" alt=" "/>
					static <?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['function_return']): ?>
