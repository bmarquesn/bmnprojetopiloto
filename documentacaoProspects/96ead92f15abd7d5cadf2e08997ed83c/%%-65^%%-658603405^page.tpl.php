...
<div class="info-box">
	...
	<div class="info-box-body">	
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "docblock.tpl", 'smarty_include_vars' => array('desc' => $this->_tpl_vars['desc'],'sdesc' => $this->_tpl_vars['sdesc'],'tags' => $this->_tpl_vars['tags'])));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
...
media/images/<?php if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png"
								 alt="<?php if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['access'] == 'private'): ?>Private<?php endif; ?> class"
								 title="<?php if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['classes'][$this->_sections['classes']['index']]['access'] == 'private'): ?>Private<?php endif; ?> class"/>
