...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'left_frame.tpl', 76, false),array('modifier', 'strip_tags', 'left_frame.tpl', 141, false),)), $this); ?>
...
?>
            ...
            var tree_classe = new WebFXTreeItem('Interface(s)', '<?php echo ((is_array($_tmp=$this->_tpl_vars['packagedoc'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
');
...
');
            ...
            var tree_classe = new WebFXTreeItem('Class(es)', '<?php echo ((is_array($_tmp=$this->_tpl_vars['packagedoc'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
');
            tree_classe.openIcon = 'media/images/class_folder.png';
            tree_classe.icon = 'media/images/class_folder.png';
...
', '<?php echo ((is_array($_tmp=$this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['link'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
');
            classe.openIcon = 'media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png';
            classe.icon = 'media/images/<?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['abstract']): ?>Abstract<?php endif;  if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['classes'][$this->_sections['class']['index']]['access'] == 'private'): ?>Private<?php endif; ?>Class.png';
            tree_classe.add(classe);
                        <?php endif; ?>
                    <?php endfor; endif; ?>
            ...
            var tree_function = new WebFXTreeItem('Function(s)', '<?php echo ((is_array($_tmp=$this->_tpl_vars['packagedoc'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
');
...
');
            ...
            subpackagetree.add(subpackagetree_classe);
                <?php endif; ?>
                    ...
                    <?php if ($this->_tpl_vars['info'][$this->_sections['p']['index']]['functions']): ?>
            var subpackagetree_function = new WebFXTreeItem('Function(s)', '<?php echo ((is_array($_tmp=$this->_tpl_vars['packagedoc'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
');
