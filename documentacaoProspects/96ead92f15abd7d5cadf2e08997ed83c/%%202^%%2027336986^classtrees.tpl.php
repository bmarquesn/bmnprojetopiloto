...
$this->_smarty_include(array('smarty_include_tpl_file' => "header.tpl", 'smarty_include_vars' => array('top1' => true)));
...
?>
<h2>Root interface <?php echo $this->_tpl_vars['interfaces'][$this->_sections['classtrees']['index']]['class']; ?>
</h2>
