...
smarty_core_load_plugins(array('plugins' => array(array('function', 'assign', 'top_frame.tpl', 23, false),)), $this); ?>
<?php echo '<?xml'; ?>
...
'/>
    ...
    <body>
        <div class="banner">
            <div class="banner-title"><h2>Documentação Prospects</h2></div>
...
$this->_sections['p']['loop'] = is_array($_loop=$this->_tpl_vars['packages']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
