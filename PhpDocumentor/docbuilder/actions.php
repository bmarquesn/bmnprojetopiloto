...
<tr>
	...
	<td>
		<input type="text" name="fileName" value="<?php echo $_SESSION['endereco_pasta'].'application'; ?>" size="60" class="text" />
	</td>
	<td style="width:100%">
	...
	<td align="right" width="100%">
		<input type="button" value="create docs" title="create docs" class="button" onclick="parent.DataFrame.document.dataForm.submit();" />
	</td>
	<td>&nbsp;</td>
</tr>
</table>
