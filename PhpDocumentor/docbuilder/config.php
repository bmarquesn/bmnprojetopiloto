...
$converters = array(
	"HTML:frames:DOM/bootstrap"		=>	'HTML:frames:DOM/bootstrap',
	...
	<div class="tab-page" id="tab_files">
		...
		<tr>
			<td align="right" valign="top" nowrap="nowrap">
				...
				<br />
				<a href="javascript:addFile(document.dataForm.setting_filename)" title="Add the file in the help box"><?php echo showImage('images/rc-gui-install-24.png', '24', '24'); ?></a>
			</td>
			<td valign="top">
				<textarea rows="5" cols="60" name="setting_filename" class="text" readonly="readonly"><?php echo $_SESSION['endereco_pasta'].'application'; ?></textarea>
			</td>
			<td valign="top" class="small">
				This is a group of comma-separated names of php files or tutorials that will be processed by phpDocumentor.<br />
			</td>
		</tr>
		<tr>
			<td align="right" valign="top" nowrap="nowrap">
				...
				<br />
				<a href="javascript:addFile(document.dataForm.setting_directory)" title="Add the file in the help box"><?php echo showImage( 'images/rc-gui-install-24.png', '24', '24' ); ?></a>
			</td>
			<td valign="top">
				<textarea rows="5" cols="60" name="setting_directory" class="text" title=""><?php echo $_SESSION['endereco_pasta'].'application'; ?></textarea>
			</td>
			<td valign="top" class="small">
				This is a group of comma-separated directories where php files or tutorials are found that will be processed by phpDocumentor. phpDocumentor automatically parses subdirectories<br />
			</td>
		</tr>
		<tr>
			<td align="right" valign="top" nowrap="nowrap">
				...
				<br />
				<a href="javascript:addFile(document.dataForm.setting_ignore)" title="Add the file in the help box"><?php echo showImage( 'images/rc-gui-install-24.png', '24', '24' ); ?></a>
			</td>
			<td valign="top">
				<textarea rows="5" cols="60" class="text" name="setting_ignore">*.html, *.img, *.css, *.xml, *.js, *.gif, *.svg, *.png, *.ico, *.cur, *.phtml, *.lock, *.iml, *.txt, .htaccess</textarea>
			</td>
			<td valign="top" class="small">
...
?></a>
		...
		<tr>
			...
			<td valign="top">
				<textarea cols="60" rows="3" name="setting_output" class="text">HTML:frames:DOM/bootstrap</textarea>
				<br />
				Output type:Converter name:template name
				<br />
<?php
	echo htmlArraySelect( $converters, 'ConverterSetting', 'size="1" class="text" onchange="swapImage(this.options[this.options.selectedIndex].value);"', 'HTML:frames' );
?>
				<br />
				...
				<br />
				<br />
				<img name="screenshot" src="images/bootstrap.png" height="200" border="2" alt="Bootstrap" />
			</td>
			<td valign="top" class="small">
	...
	<div class="tab-page" id="tab_options">
		...
		<table cellspacing="0" cellpadding="3" border="0">
		<tr>
			<td nowrap="nowrap"><b>Generated Documentation Title</b></td>
			<td><input type="text" name="setting_title" size="40" class="text" value="DocumentacaoProspects" /></td>
			<td class="small">Choose a title for the generated documentation</td>
		</tr>
		<tr>
			<td nowrap="nowrap"><b>Default Package Name</b></td>
			<td><input type="TEXT" name="setting_defaultpackagename" size="40" class="text" value="BrunoMarquesProspects" /></td>
			<td class="small">Choose a name for the default package</td>
		</tr>
		<tr>
			<td nowrap="nowrap"><b>Default Category Name</b></td>
			<td><input type="TEXT" name="setting_defaultcategoryname" size="40" class="text" value="BrunoMarquesProject" /></td>
			<td class="small">Choose a name for the default category.  This is only used by the peardoc2 converter</td>
		</tr>
		<tr>
			<td nowrap="nowrap">
				<b>Custom Tags</b>
		...
		<tr>
			...
			<td nowrap="nowrap">
                            <input type="checkbox" name="setting_sourcecode" value="on" checked="checked" />
			</td>
			<td class="small">
	...
	<div class="tab-page" id="tab_links">
		...
		<ul>
			<li><a target="_blank" href="http://www.phpdoc.org/manual.php">phpDocumentor manual</a> - Learn how to use phpDocumentor to document your PHP source code</li>
            <li><a target="_blank" href="http://pear.php.net/package/PhpDocumentor/">phpDocumentor homepage</a> on PEAR</li>
			<li><a target="_blank" href="http://phpdocu.sourceforge.net/">phpDocumentor homepage</a> on SourceForge</li>
			<li><a target="_blank" href="http://freshmeat.net/projects/phpdocu">Freshmeat record</a> - subscribe here</li>
		</ul>
	</div>
</div>
